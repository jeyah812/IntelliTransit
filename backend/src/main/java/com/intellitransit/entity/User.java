...
public class User {
    ...
    public User(Long id, String username, String email, String password, UserRole role, boolean enabled, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
    ...
    public static class UserBuilder {
        ...
        public User build() {
            return new User(id, username, email, password, role, enabled, createdAt, updatedAt);
        }
    }
}
